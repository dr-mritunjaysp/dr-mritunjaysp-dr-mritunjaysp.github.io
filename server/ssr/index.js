...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-Cf4mxF9d.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-7uI2t8DX.js");
		return {
			get "ErrorBoundary"() {
	...
	"ab59f52a2ee1": async () => {
		const m = await import("./assets/PortfolioApp-BwSA3F_Q.js");
