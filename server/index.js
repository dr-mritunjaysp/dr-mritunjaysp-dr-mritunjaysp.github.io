globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/index.esm-CopmASRU.js","assets/query-D8Wk3mvj.js","assets/PortfolioApp-BV7mrhgY.js","assets/index.esm-QhMgEveZ.js","assets/index.esm-BAPkrcuE.js","assets/lottie-BfKPa540.js","assets/layout-segment-context-BOoCvQCg.js","assets/router-CAfFKoR8.js"];
...
function getDraftSecret() {
	return "1a3735d6-8dee-49a0-bd57-375259432daa";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e98d29ec-b554-4d38-b66c-2b1dd1c53af6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e98d29ec-b554-4d38-b66c-2b1dd1c53af6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e98d29ec-b554-4d38-b66c-2b1dd1c53af6",
		rootBoundaryId
	});
}
/**
...
var PortfolioApp = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'PortfolioApp' is called on server");
}, "ab59f52a2ee1", "PortfolioApp");
//#endregion
//#region app/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioApp, { section: "home" });
}
...
//#endregion
//#region \0virtual:vinext-google-fonts?fonts=Geist_Mono
...
async function generateMetadata() {
	...
	const host = requestHeaders.get("x-forwarded-host") ?? requestHeaders.get("host") ?? "dr-mritunjaysp.com";
	const origin = `${requestHeaders.get("x-forwarded-proto") ?? (host.includes("localhost") ? "http" : "https")}://${host}`;
	return {
		...
		description: "Academic portfolio of Dr. Mritunjay Shall Peelam, Assistant Professor (Selection Grade) at UPES Dehradun, researching Blockchain, IoT, Edge AI, Federated Learning, and Multimodal Machine Learning.",
		keywords: [
		...
		openGraph: {
			...
			description: "Assistant Professor (Selection Grade) · Researcher in Blockchain, IoT, Edge AI, and Multimodal ML.",
...
function RootLayout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("head", { children: [
		...
		] }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("body", {
...
async function SectionPage({ params }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(PortfolioApp, { section });
}
//#endregion
...
var __publicFiles = new Set([
	...
	"/documents/Dr-Mritunjay-resume.pdf",
	"/downloads/Inkora-App-Beta-Guide.txt",
	"/downloads/Inkora-Setup-1.0.0-x64.exe",
	"/fonts/FedraSansStdBook.otf",
	"/fonts/roboto-latin.woff2",
	"/inkora-logo.png",
	"/inkora-studio.png",
	"/lottie/fish.json",
	"/lottie/home-button.json",
	"/lottie/search-icon.json",
	"/lottie/theme-toggle.json",
	"/lottie/tiktok-bullet-loader.json",
	"/media/badrinath.jpg",
	"/media/chakarata.jpg",
	"/media/computer-organization.jpg",
	"/media/data-structures.jpg",
	"/media/kedarnath.jpg",
	"/media/operating-systems.jpg",
	"/media/profile-circle-png.svg",
	"/media/profile-circle.png",
	"/media/profile-circle.svg",
	"/media/profile-color.jpg",
	"/media/profile.png",
	"/media/software-engineering.jpg",
	"/media/view.gif",
	"/og.png"
]);
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: { "/:section": generateStaticParams ?? null },
