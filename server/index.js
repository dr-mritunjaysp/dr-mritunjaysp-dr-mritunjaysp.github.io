...
function getDraftSecret() {
	return "a9c12b1a-9ebd-4483-866a-619b1be33619";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "a8b7fb3b-b34a-4307-b6a0-4092a29e6f51";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "a8b7fb3b-b34a-4307-b6a0-4092a29e6f51") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "a8b7fb3b-b34a-4307-b6a0-4092a29e6f51",
		rootBoundaryId
	});
}
/**
