...
function getDraftSecret() {
	return "796be511-de67-46a4-867a-faf3fc1437f5";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "061e4be8-d065-4b25-858f-6d43237a750a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "061e4be8-d065-4b25-858f-6d43237a750a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "061e4be8-d065-4b25-858f-6d43237a750a",
		rootBoundaryId
	});
}
/**
