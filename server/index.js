...
function getDraftSecret() {
	return "7842492c-8507-4024-8082-9fa8feddc7fa";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5972c5e0-9cf1-44a0-ac92-9181fcf74c2a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5972c5e0-9cf1-44a0-ac92-9181fcf74c2a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5972c5e0-9cf1-44a0-ac92-9181fcf74c2a",
		rootBoundaryId
	});
}
/**
