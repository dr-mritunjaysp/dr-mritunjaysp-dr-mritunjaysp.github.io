...
function getDraftSecret() {
	return "bbdcff06-ad9c-44e4-833c-dc50f7e8b9c4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e34979fd-0a70-4d5d-a302-60d3b426d758";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e34979fd-0a70-4d5d-a302-60d3b426d758") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e34979fd-0a70-4d5d-a302-60d3b426d758",
		rootBoundaryId
	});
}
/**
