...
function getDraftSecret() {
	return "5b24a4ea-8837-444c-973b-5ea00ae1cc21";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2a80c76d-fa4e-45fd-9003-0e2ccd0218aa";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2a80c76d-fa4e-45fd-9003-0e2ccd0218aa") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2a80c76d-fa4e-45fd-9003-0e2ccd0218aa",
		rootBoundaryId
	});
}
/**
