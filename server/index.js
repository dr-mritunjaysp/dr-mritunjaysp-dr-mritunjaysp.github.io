...
function getDraftSecret() {
	return "82df3021-d2be-4e24-84c8-8497fb68e379";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "24431dae-4bcf-41d2-aac6-68c718ab5ac0";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "24431dae-4bcf-41d2-aac6-68c718ab5ac0") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "24431dae-4bcf-41d2-aac6-68c718ab5ac0",
		rootBoundaryId
	});
}
/**
