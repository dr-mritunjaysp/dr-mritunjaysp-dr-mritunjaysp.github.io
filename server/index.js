...
function getDraftSecret() {
	return "797a66ae-0d1c-469d-aaf0-11a267a95077";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "04b0d436-fef1-4502-abae-af71772acf38";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "04b0d436-fef1-4502-abae-af71772acf38") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "04b0d436-fef1-4502-abae-af71772acf38",
		rootBoundaryId
	});
}
/**
