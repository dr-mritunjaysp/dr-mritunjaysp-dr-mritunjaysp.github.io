...
function getDraftSecret() {
	return "6f64ccf8-9104-4d16-ad46-69802264bd43";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "56c6cf51-c7c0-40c8-950e-f87f865d3bf5";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "56c6cf51-c7c0-40c8-950e-f87f865d3bf5") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "56c6cf51-c7c0-40c8-950e-f87f865d3bf5",
		rootBoundaryId
	});
}
/**
