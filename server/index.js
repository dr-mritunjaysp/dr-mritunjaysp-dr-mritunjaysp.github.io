...
function getDraftSecret() {
	return "d0d80b06-8be8-44ec-a56a-bba7fd9126eb";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6682a107-7c5f-449a-928d-98f540321a5b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6682a107-7c5f-449a-928d-98f540321a5b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6682a107-7c5f-449a-928d-98f540321a5b",
		rootBoundaryId
	});
}
/**
